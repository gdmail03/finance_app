...
# Sidebar
menu = st.sidebar.radio("Navigate", ["Dashboard", "Manage Entries", "Forecast", "Goals", "Suggestions"])
...
# Manage Entries sub-navigation
elif menu == "Manage Entries":
    manage_option = st.selectbox(
        "Manage Entries",
        ["Show All Entries", "Add Entry", "Edit Entry"]
    )

    # Show All Entries Page
    if manage_option == "Show All Entries":
